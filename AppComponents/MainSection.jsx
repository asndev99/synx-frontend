  ...
  return (
    <div className="flex flex-col items-center p-10 w-full bg-[#0E0E11] cursor-pointer text-white ">
      ...
      <div className="flex mt-4 gap-4 w-full md:flex-row flex-col items-center">
        <div className="flex flex-col p-4 gap-3 bg-[#282836] hover:bg-[#434252] rounded-lg items-center w-[60vw] h-[30vh] md:h-[30vh]  select-none cursor-pointer text-white">
        ...
        <div className="flex flex-col  gap-3 p-4 bg-[#282836] hover:bg-[#434252] rounded-lg items-center w-[60vw] h-[30vh] md:h-[30vh] text-white   ">
        ...
        <div className="flex flex-col gap-3 p-4 bg-[#282836] hover:bg-[#434252] rounded-lg text-white  w-[60vw] h-[30vh] md:h-[30vh]  items-center ">
