...
const LoginForm = () => {
  ...
  return (
    ...
    <div className="h-max mx-auto flex flex-col items-center">
        ...
        <h1 className="text-xl font-bold text-center pb-10">Login into  your account</h1>
        <form  onSubmit={handleSubmit(onsubmit)} className="bg-white shadow-lg p-10 flex flex-col gap-4 text-sm rounded-lg" >
            <div >
            ...
            <div>
                <input className="bg-blue-500 w-full py-2 rounded-md text-white font-bold cursor-pointer hover:bg-blue-700" type="submit" value="Login" />
            </div>
